...
export default function Home() { const [showForm, setShowForm] = useState(false); const [titre, setTitre] = useState(""); const [description, setDescription] = useState(""); const [ville, setVille] = useState(""); const [message, setMessage] = useState("");
async function publierDon() { setMessage("");
...
return ( <main style={{ padding: "30px", maxWidth: "700px", margin: "auto" }}> Donner.ma
